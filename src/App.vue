    ...
    <nav class="max-w-7xl px-5 md:fixed top-0 z-[98] w-screen backdrop-blur-md bg-[#121212] bg-opacity-80">
      <div class="container mx-auto flex flex-wrap items-center justify-between">
        <button @click="redirectToHome" class="flex">
          <span class="self-center text-lg text-[#ffdb70] font-semibold whitespace-nowrap fadein-bot hover:text-amber-100">Asy Syams Darussalam</span>
        </button>
        <div class="flex md:order-2 fadein-bot">
          <a href="https://github.com/asysyamsd?tab=repositories"><img class="w-9 rounded-full" src="https://seeklogo.com/images/G/github-logo-2E3852456C-seeklogo.com.png" alt="github"></a>
          <a href="https://www.instagram.com/asysyamsd_4/"><img class="w-9 rounded-full ml-3" src="https://static.vecteezy.com/system/resources/previews/019/874/344/large_2x/instagram-apps-icon-free-png.png" alt="instagram"></a>
          <a href="https://www.linkedin.com/in/asy-syams-darussalam-57b521246/"><img class="w-9 rounded-full ml-3" :src="'linkedin.png'"></a>
        </div>
