<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      <p class="text-amber-200">Hello Friends, I'm</p>
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Asy Syams Darussalam</h1>
      <div class="py-2">
        <h1
      ...
      <br>
      <a href="https://drive.google.com/file/d/1qUDljFRUJR3p5FXofdBPRYaRDVOVR6yv/view?usp=sharing" target="_blank" rel="noopener noreferrer">
      <button
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" :src="'/img/myfoto.png'">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Front-End Developer", "Data Analyst", "Bachelor of Informatics Engineering", "Tech Enthusiast"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
